...
<main class="container my-5">
    <form action="<?php echo e(route('treatmentresults.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php /**PATH C:\xampp\htdocs\arissimapi\resources\views/treatmentResults/create.blade.php ENDPATH**/ ?>