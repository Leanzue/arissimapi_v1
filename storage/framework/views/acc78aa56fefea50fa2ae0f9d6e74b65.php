...
<main class="container my-5">
    <form action="<?php echo e(route('treatmentattempts.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php /**PATH C:\xampp\htdocs\arissimapi\resources\views/treatmentattempts/create.blade.php ENDPATH**/ ?>